...
class MultiAIConsiliumRunORM(Base):
    ...
    system_prompt_version: Mapped[str] = mapped_column(String(50), nullable=False, default="multi-ai-system.v1")
    round_one_prompt_version: Mapped[str] = mapped_column(String(50), nullable=False, default="multi-ai-round-one.v1")
    round_two_prompt_version: Mapped[str] = mapped_column(String(50), nullable=False, default="multi-ai-round-two.v1")
    devil_prompt_version: Mapped[str] = mapped_column(String(50), nullable=False, default="multi-ai-devil.v1")
    case_package_hash: Mapped[str] = mapped_column(String(64), nullable=False, default="")
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False, default=lambda: datetime.now(timezone.utc)
    )
...
class MultiAIConsiliumParticipantORM(Base):
    ...
    provider_model: Mapped[str] = mapped_column(String(120), nullable=False, default="placeholder")
    ...
    real_provider_call: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
