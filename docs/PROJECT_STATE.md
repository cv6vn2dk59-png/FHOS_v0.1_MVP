...
- Contraindications v1 — domain + persistence + seed (ADR-0014,
  ...
  Обидва боки мапінгу (Substance→CHEBI, S07E03; Diseases→MONDO,
  S07E04) тепер технічно існують (див. Shared/локальні модулі нижче),
  але рішення писати application-шар — ОКРЕМЕ, не прийняте автоматично
  (ADR-0014, оновлення S07E04): жоден ланцюжок не перевірений на
...
- ADR-0014 — Contraindications v1 Domain Scope (обидва мапінги
  технічно існують від S07E04, application-шар усе ще НЕ написаний —
  окреме рішення, не автоматичний наслідок)
...
- Contraindications application-шар усе ще НЕ написаний (ADR-0014,
  оновлення S07E04): обидва боки мапінгу тепер технічно існують
  (substance-side — 4 речовини, disease-side — 10 хвороб / 11 ключів),
  але ЖОДЕН ланцюжок (Medications.drug_name→...→CHEBI,
  Diseases.diagnosis_name→...→MONDO) не перевірений на реальному
  пацієнтському записі — лише на тестових фікстурах. Рішення писати
  application-шар — окреме, не прийняте цим оновленням
